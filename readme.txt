...
Tags: picture, pictures, gallery, galleries, circular, circle, coverflow, flow, image, images, flow, lightbox, carousel, autorotate, automatic, rotate, media, tages
...
1. Select the images attached to your post/page with the shortcode [wp-iscircularphoto]
...
3. Configure the gallery in Settings -> IS Circular Photo Gallery.
...
2. Use the shortcode [wp-iscircularphoto] anywhere in the post or page
...
4. Insert a gallery on a page by specifying the shortcode [wp-iscircularphoto dir=subfolder] on your post or page.
...
1. IS Circular Photo Gallery, captions enabled
2. IS Circular Photo Gallery, captions disabled
3. Choose the options you need
4. IS Circular Photo Gallery, Large picture width = Container width CSS (640 px); Large picture height = Container height (480px); captions enabled.

== Changelog ==

Version 1.9 (January 13, 2014)
